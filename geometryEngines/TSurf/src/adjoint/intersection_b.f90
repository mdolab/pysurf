...
&                                    isectpointa2b, coplanar, intersect)
      ...
      d2b = dv1b + dv0b + dv2b
      n2b = 0.0
      CALL DOT_B(n2, n2b, v2, v2b, result1b)
      result1b = dv1b
      CALL DOT_B(n2, n2b, v1, v1b, result1b)
      result1b = dv0b
      CALL DOT_B(n2, n2b, v0, v0b, result1b)
      result1b = -d2b
      CALL DOT_B(n2, n2b, u0, u0b, result1b)
    ...
    d1b = du1b + du0b + du2b
    n1b = 0.0
    CALL DOT_B(n1, n1b, u2, u2b, result1b)
    result1b = du1b
    CALL DOT_B(n1, n1b, u1, u1b, result1b)
    result1b = du0b
    CALL DOT_B(n1, n1b, u0, u0b, result1b)
    result1b = -d1b
    CALL DOT_B(n1, n1b, v0, v0b, result1b)
    e1 = v1 - v0
    e2 = v2 - v0
...
&   )
    ...
    diff = vtx1 - vtx0
    tmp = d0/(d0-d2)
    CALL PUSHREAL4ARRAY(diff, realtype*3/4)
    diff = vtx2 - vtx0
    diffb = 0.0
    diffb = isectpoint1b
    tmpb = SUM(diff*diffb)
    ...
    CALL POPREAL4ARRAY(diff, realtype*3/4)
    vtx2b = vtx2b + diffb
    tempb = tmpb/(d0-d2)
    tempb0 = -(d0*tempb/(d0-d2))
    d2b = -tempb0
    diffb = 0.0
    diffb = isectpoint0b
    tmp = d0/(d0-d1)
    ...
    vtx1b = vtx1b + diffb
    tempb1 = tmpb/(d0-d1)
    tempb2 = -(d0*tempb1/(d0-d1))
    d0b = tempb1 + tempb2 + tempb0 + tempb
    d1b = -tempb2
