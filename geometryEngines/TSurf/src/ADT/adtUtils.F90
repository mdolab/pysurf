...
! Ney Secco 08-2016
        ...
        subroutine triaProjection(x1, x2, x3, &
          ...
          !
          ! norm: real(3) -> Surface normal at projected point.
          !
          ...
          real(kind=realType), dimension(3), intent(out) :: norm
        ...
        subroutine quadProjection(x1, x2, x3, x4, &
          ...
          ! Output variables
          real(kind=realType), dimension(3), intent(out) :: xf, norm
          real(kind=realType), intent(out) :: u, v, val
        ...
        subroutine quadProjSubIter(x1, x2, x3, x4, &
          ...
          real(kind=realType), dimension(3) :: vf, a, b, vt
          real(kind=realType), dimension(3) :: an, bn
