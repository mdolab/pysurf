...
X,Y,Z = hypsurf.create_mesh(rBaseline, bc1, bc2, sBaseline, numLayers, extension, surf,
...
# Plot results
fig = hypsurf.plot_grid(X,Y,Z,show=False)
fig.savefig('output.png')
hypsurf.export_plot3d(X,Y,Z,'output.xyz')
