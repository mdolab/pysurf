...
class Hypsurfapi(f90wrap.runtime.FortranModule):
    ...
    """
    @staticmethod
    def computematrices(r0, n0, s0, rm1, sm1, layerindex, theta, sigmasplay, bc1, \
        bc2, numlayers, epse0, f, numnodes):
        """
        ...
        """
        _mod.f90wrap_computematrices(r0=r0, n0=n0, s0=s0, rm1=rm1, sm1=sm1, \
            layerindex=layerindex, theta=theta, sigmasplay=sigmasplay, bc1=bc1, bc2=bc2, \
            numlayers=numlayers, epse0=epse0, f=f, numnodes=numnodes)
    
    @staticmethod
    def matrixbuilder(curr_index, bc1, bc2, r0, rm1, n0, s0, sm1, numlayers, epse0, \
        ...
        """
        _mod.f90wrap_matrixbuilder(curr_index=curr_index, bc1=bc1, bc2=bc2, r0=r0, \
            rm1=rm1, n0=n0, s0=s0, sm1=sm1, numlayers=numlayers, epse0=epse0, \
            layerindex=layerindex, theta=theta, numnodes=numnodes, k=k, f=f)
    ...
    def dissipationcoefficients(layerindex, r0_xi, r0_eta, dsensor, angle, \
        ...
        """
        epse, epsi = _mod.f90wrap_dissipationcoefficients(layerindex=layerindex, \
            r0_xi=r0_xi, r0_eta=r0_eta, dsensor=dsensor, angle=angle, \
            numlayers=numlayers, epse0=epse0)
        return epse, epsi
    ...
    def areafactor(r0, d, nuarea, numareapasses, bc1, bc2, n, s):
        ...
        """
        maxstretch = _mod.f90wrap_areafactor(r0=r0, d=d, nuarea=nuarea, \
            numareapasses=numareapasses, bc1=bc1, bc2=bc2, n=n, s=s)
        return maxstretch
    ...
    def smoothing(r, eta, alphap0, numsmoothingpasses, numlayers, n):
        ...
        """
        _mod.f90wrap_smoothing(r=r, eta=eta, alphap0=alphap0, \
            numsmoothingpasses=numsmoothingpasses, numlayers=numlayers, n=n)
    ...
    def qualitycheck(r, numlayers, numnodes, ratios, layerindex=None):
        ...
        """
        fail = _mod.f90wrap_qualitycheck(r=r, numlayers=numlayers, numnodes=numnodes, \
            ratios=ratios, layerindex=layerindex)
        return fail
    
    @staticmethod
    def march(py_projection, rstart, dstart, theta, sigmasplay, bc1, bc2, \
        ...
        """
        fail = _mod.f90wrap_march(py_projection=py_projection, rstart=rstart, \
            dstart=dstart, theta=theta, sigmasplay=sigmasplay, bc1=bc1, bc2=bc2, \
            plotquality=plotquality, epse0=epse0, alphap0=alphap0, extension=extension, \
            nuarea=nuarea, ratioguess=ratioguess, cmax=cmax, \
            numsmoothingpasses=numsmoothingpasses, numareapasses=numareapasses, \
            numlayers=numlayers, numnodes=numnodes, r=r, ratios=ratios)
        return fail
    ...
    def findratio(dmax, d0, numlayers, ratioguess):
        ...
        """
        q = _mod.f90wrap_findratio(dmax=dmax, d0=d0, numlayers=numlayers, \
