...
!   gradient     of useful results: rnew
!   with respect to varying inputs: s0 rnew sm1 n0 rm1 r0
!   rw status of diff variables: s0:out rnew:in-zero sm1:out n0:out
!                rm1:out r0:out
!=================================================================
!=================================================================
...
& )
    use solveroutines, only : solve, solve_b
    implicit none
