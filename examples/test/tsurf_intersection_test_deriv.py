...
def curve_intersection_internal(deltaZ, ii):
    ...
    for curve in comp1.curves:
        if "int" in curve:
            ...
            coorIntd = pysurf.tsurf_tools._compute_pair_intersection_d(comp1, comp2, intCurve, coor1d, coor2d, distTol)
            ...
            coor1b, coor2b = pysurf.tsurf_tools._compute_pair_intersection_b(comp1, comp2, intCurve, coorIntb, distTol)
            ...
            Intersections = pysurf.tsurf_tools._compute_pair_intersection(comp1, comp2, distTol)
            ...
            coorAb, coorBb = pysurf.tsurf_tools._compute_pair_intersection_b(comp1, comp2, intCurve, coorIntb, distTol)
