...
def curve_intersection_internal(deltaZ,ii):
    ...
    # Apply translation
    comp1.translate(0,0.0,deltaZ)

    # Call intersection function
    Intersections = comp1.intersect(comp2)
    ...
    for curve in Intersections:
        if True:
            ...
            newCoorIntd = intCurve.remesh_d(coorIntd)
            ...
            coorIntb = intCurve.remesh_b(newCoorIntb)
...
class TestIntersectionDerivs(unittest.TestCase):
    ...
    def test_intersection_derivative(self):
        curve_intersection_internal(0, 0)
